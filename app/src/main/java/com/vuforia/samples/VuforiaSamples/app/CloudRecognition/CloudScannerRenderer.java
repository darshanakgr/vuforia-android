...
public class CloudScannerRenderer implements GLSurfaceView.Renderer, SampleAppRendererControl
{
    ...
    private CloudScanner mActivity;

    private boolean mIsActive = false;

    public CloudScannerRenderer(SampleApplicationSession session, CloudScanner activity)
    {
